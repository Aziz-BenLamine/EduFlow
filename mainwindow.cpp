    ...
    , statsWindow(nullptr)
{
    ...
    clarifaiNetworkManager = new QNetworkAccessManager(this);

    connect(chatNetworkManager, &QNetworkAccessManager::finished, this, &MainWindow::on_chatReplyFinished);
    connect(clarifaiNetworkManager, &QNetworkAccessManager::finished, this, &MainWindow::onClarifaiReplyFinished);
    // === Table Refresh Setup ===
    ...
    ui->label_66->setPixmap(QPixmap("C:\\ESPRIT\\Qt\\EduFlow\\res\\send.jpg").scaled(32, 32, Qt::KeepAspectRatio));
...
void MainWindow::on_sendChatButton_clicked()
{
    ...
    connect(testReply, &QNetworkReply::finished, this, [this, testReply, userMessage, testManager]() {
        ...
        connect(chatNetworkManager, &QNetworkAccessManager::sslErrors, this, [](QNetworkReply *reply, const QList<QSslError> &errors) {
            for (const QSslError &error : errors) {
        ...
        chatNetworkManager->post(request, data);
    });
...
void MainWindow::on_utiliserEquipement_clicked() {
    ...
    if (serialPort->isOpen()) {
        ...
        /*if (initializeSerialPort()) {
            serialPort->write("1");
            serialPort->flush();on_AjouterEquipement_clicked
            QMessageBox::information(this, "Succès", "Équipement '" + nomEq + "' utilisé avec succès ! Quantité mise à jour.");
        } else {
...
void MainWindow::on_AjouterEquipement_clicked() {
    ...
    clarifaiNetworkManager->post(request, jsonData); // Use clarifaiNetworkManager
